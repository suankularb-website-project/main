                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    {departments.map((item, index) => (
                        <Card
                            ...
                            cover={<div className="h-[10.75rem] lg:h-60 justify-center"><Image alt={item.name} src={`/static/science-pic/${item.id}.png`} width={900} height={200} className="w-auto h-full mx-auto" /></div>}
